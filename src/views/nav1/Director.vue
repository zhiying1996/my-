...
<el-dialog
    ...
    >
      ...
      <el-table-column align="center" prop="msg" label="内容" class="abc"></el-table-column>      
      ...
      ></el-table-column> -->
       <el-table-column align="center" label="操作" width="60px">
        ...
        <el-button @click="deleteRow(scope.row.id,scope.row.taskId)" type="text" size="small">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="fenye">
...
export default {
  ...
  methods: {
    ...
    var that = this;
    that.$router.push({
    path: "/TaskDetailsPage1",
    name: "TaskDetailsPage1",
    params: {
     catchId: id,
     taskId:taskId
    }
